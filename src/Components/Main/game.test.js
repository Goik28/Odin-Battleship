...
test("Random attack valid place", () => {
  ...
  if (player2.turn == true) {
    expect(player1.gameBoard.missedAttacks || player1.gameBoard.rightAttacks).toHaveLength(1);  
  }else{
    expect(player2.gameBoard.missedAttacks || player2.gameBoard.rightAttacks).toHaveLength(1);  
  }
